		...
		<div class="grid-80">
			<div class="grid-block">	
				<div class="index-intro-text">
					<h2>Branch-wise student list</h2><hr>
					<h3>B. Tech.</h3>
					<a href="studentlist.php?branch=0&type=0"><?php echo getBranchName(0); ?></a><br>
					<a href="studentlist.php?branch=1&type=0"><?php echo getBranchName(1); ?></a><br>
					<a href="studentlist.php?branch=2&type=0"><?php echo getBranchName(2); ?></a><br>
					<!-- <h3>M. Tech.</h3>
